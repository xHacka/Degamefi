// https://codesandbox.io/s/github/rcbyr/keen-slider-sandboxes/tree/v6/basic/free-snap-mode/react?file=/src/App.js
  ...
  return (
    ...
    >
      {speakers.map((speaker) => (
        ...
        >
          <Image className="speaker-img" borderRadius="50%" src={speaker.img} />
          <Box
