    ...
    <Box bg="#2D0A5D" color="#FFF">
      <Container as={Stack} maxW={"8xl"} py={10}>
        <SimpleGrid columns={{ base: 1, sm: 2, md: 3 }} spacing={8}>
          ...
          <Stack align={"flex-start"}>
            <ListHeader color="#FFF" fontSize="1.5em">Guide</ListHeader>
            <Text>
          ...
          <Stack align={"flex-start"}>
            <ListHeader color="#FFF" fontSize="1.5em">Company</ListHeader>
            <Link href="#aboutus">About us</Link>
            <Link href="">FAQ</Link>
            <Link href="">Projects</Link>
            <Link href="mailto:info@degamefi.io">Contact</Link>
          </Stack>
        </SimpleGrid>
      </Container>
